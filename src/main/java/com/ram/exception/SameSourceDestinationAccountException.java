 ...
 */
public class SameSourceDestinationAccountException extends CustomException {

    public SameSourceDestinationAccountException(String message) {
        super(message);
    }
    ...
    public ErrorResponse format() {
        return new ErrorResponse(HttpStatus.BAD_REQUEST_400, newArrayList(
                new ErrorData("account", getMessage())
        ));
    }
}
